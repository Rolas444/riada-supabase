            ...
            <form >
                ...
                <div className="relative">
                    ...
                    <input type="search" id="default-search"
                        ...
                        dark:text-white dark:focus:ring-soft dark:focus:border-soft" placeholder="..." required />
                    <button type="submit"
                        className="text-invert absolute right-2.5 bottom-2.5 bg-soft hover:bg-soft focus:ring-4 focus:outline-none
